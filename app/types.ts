...
export type PublicStatus = 'open' | 'closing_soon' | 'likely_to_open'
...
export type SearchInput = { origin_country: string; program_levels: string[]; target_countries: string[]; field?: string; limit: number; cursor?: string }
export type MatchProfile = { origin_country: string; program_levels: string[]; field?: string }
