...
if (report.errors.length || report.failedRequests.length || report.desktop.horizontalOverflow || report.mobile.horizontalOverflow || report.desktop.axeSeriousOrCritical.length || report.mobile.axeSeriousOrCritical.length || (strictNetwork && report.blockedExternalRequests.length)) process.exitCode = 1
